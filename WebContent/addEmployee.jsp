...
<body style="text-align: center;">
  ...
  <div class="container"> 
   <div id="content"> 
    	<form  class="form-horizontal" id="inputForm"  action="${pageContext.request.contextPath}/servlet/AddEmployeeServlet" method="post">
        <fieldset>
          ...
          <div style="padding:10px;"> 
    		<div class="control-group">
             <div class="row">
              ...
              <div class="col-sm-6">
    			<input type="text"  class="form-control required"  name="id" value="${formBean.id}"/>
              </div>
             </div> 
            </div>
    		<div class="control-group">
             <div class="row">
              ...
              <div class="col-sm-6">
    			<input type="text" class="form-control required"   name="name" value="${formBean.name}"/>
              </div>
             </div> 
            </div>
    		<div class="control-group">
             <div class="row">
              ...
              <div class="col-sm-6">
    					<input  class="form-inline help-inline" type="radio" name="gender" value="1" ${formBean.gender=="1"?"checked='checked'":""}/>男
    					<input  class="form-inline help-inline" type="radio" name="gender" value="0" ${formBean.gender=="0"?"checked='checked'":""}/>女
              </div>
             </div> 
            </div>
    		<div class="control-group">
             <div class="row">
              ...
              <div class="col-sm-6">
    					<input type="text" class="form-control required"  name="birthday" value="${formBean.birthday}"/>${formBean.errors.birthday}
              </div>
             </div> 
            </div>
    		<div class="control-group">
             <div class="row">
              ...
              <div class="col-sm-6">
    					<input type="text"   class="form-control required"   name="cellphone" value="${formBean.cellphone}"/>
              </div>
             </div> 
            </div>
    		<div class="control-group">
             <div class="row">
              ...
              <div class="col-sm-6">
    					<input type="text" class="form-control required" name="email" value="${formBean.email}"/>
              </div>
             </div> 
            </div>
    		<div class="control-group">
